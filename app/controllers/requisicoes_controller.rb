class RequisicoesController < ApplicationController
  ...
  def requisicao_params
    params.require(:requisicao).permit(:numero_requisicao, :paciente_id,
                                       amostras_attributes: %i[ numero_amostra data_coleta tipo_amostra
                                                                status_amostra_id material_biologico_id],
                                       informacao_clinica_attributes: %i[ data_inicio_sintomas idade_gestacional
